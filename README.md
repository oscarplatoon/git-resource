...
**NOTE:** The following exercises on git are borrowed from [The Odin Project](https://github.com/TheOdinProject) because we think they've done a great job explaining this.
...
## A Cheatsheet
Here is a reference list of the most commonly used git commands (you might consider bookmarking this handy webpage). Try to familiarize yourself with the commands and then eventually remember them:
